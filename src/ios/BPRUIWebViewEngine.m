...
#import "BPRUIWebViewDelegate.h"
#import "BPRUIWebViewNavigationDelegate.h"
#import <Cordova/NSDictionary+CordovaPreferences.h>

#import <objc/message.h>

@interface BPRUIWebViewEngine ()

@property (nonatomic, strong, readwrite) UIView* engineWebView;
@property (nonatomic, strong, readwrite) id <UIWebViewDelegate> uiWebViewDelegate;
@property (nonatomic, strong, readwrite) BPRUIWebViewNavigationDelegate* navWebViewDelegate;

@end

@implementation BPRUIWebViewEngine
...
- (void)pluginInitialize
{
    ...
    if ([self.viewController conformsToProtocol:@protocol(UIWebViewDelegate)]) {
        self.uiWebViewDelegate = [[BPRUIWebViewDelegate alloc] initWithDelegate:(id <UIWebViewDelegate>)self.viewController];
        uiWebView.delegate = self.uiWebViewDelegate;
    } else {
        self.navWebViewDelegate = [[BPRUIWebViewNavigationDelegate alloc] initWithEnginePlugin:self];
        self.uiWebViewDelegate = [[BPRUIWebViewDelegate alloc] initWithDelegate:self.navWebViewDelegate];
        uiWebView.delegate = self.uiWebViewDelegate;
    }
...
- (void)updateWithInfo:(NSDictionary*)info
{
    ...
    if (uiWebViewDelegate &&
        ...
        self.uiWebViewDelegate = [[BPRUIWebViewDelegate alloc] initWithDelegate:(id <UIWebViewDelegate>)uiWebViewDelegate];
        uiWebView.delegate = self.uiWebViewDelegate;
    }
