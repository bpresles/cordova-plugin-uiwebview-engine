...
@interface BPRUIWebViewDelegate2 : BPRUIWebViewDelegate {}
...
@implementation  BPRUIWebViewDelegate2
...
@interface BPRUIWebViewDelegate ()
...
@interface BPRUIWebViewDelegateTests : XCTestCase
@end

@implementation BPRUIWebViewDelegateTests
...
- (void)testShouldLoadRequestWithStateWaitForStart
{
    ...
    BPRUIWebViewDelegate2* wvd = [[BPRUIWebViewDelegate2 alloc] initWithDelegate:nil]; // not really testing delegate handling
...
{
    BPRUIWebViewDelegate* wvd = [[BPRUIWebViewDelegate alloc] initWithDelegate:nil]; // not really testing delegate handling
